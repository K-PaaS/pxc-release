...
## 03. Submodule modify : cluster-health-logger - go-sql-driver (src/github.com/cloudfoundry-incubator/cf-mysql-cluster-health-logger)

> $ vi src/github.com/cloudfoundry-incubator/cf-mysql-cluster-health-logger/vendor/github.com/go-sql-driver/mysql/auth.go
```diff
func (mc *mysqlConn) auth(authData []byte, plugin string) ([]byte, error) {
        switch plugin {
        case "caching_sha2_password":
